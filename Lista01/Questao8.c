...
prestações, de acordo com as regras acima.Observe que uma justificativa para a adoção
desta regra é que ela facilita a confecção e o conseqüente pagamento dos boletos das
duas prestações.*/
...
int main()
{
	...
	parcelas = (int) (ValorMercadoria/3);
	entrada = ValorMercadoria - (parcelas * 2);
	
	printf("Entrada de: R$ %.2f\n", entrada);
	printf("2 parcelas de:R$ %d\n", parcelas);
